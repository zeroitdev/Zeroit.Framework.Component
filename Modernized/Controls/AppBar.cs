...
using Zeroit.Framework.Components.Modernized.Objects.MenuItems;
...
namespace Zeroit.Framework.Components.Modernized.Controls
{
    ...
    public class ZeroitAppBar : Control
    {
        ...
        public ZeroitAppBar()
        {
            ...
            Size = new Size(10, RoundUp((int) (Zeroit.Framework.Components.Modernized.Forms.ModernForm.DefaultTitlebarHeight * 1.5d)));
            Dock = DockStyle.Top;
            Load += AppBar_Load;
        ...
        {
            get => Parent != null && Parent is Zeroit.Framework.Components.Modernized.Forms.ModernForm ? ((Zeroit.Framework.Components.Modernized.Forms.ModernForm) Parent).ColorScheme : _colorScheme;
