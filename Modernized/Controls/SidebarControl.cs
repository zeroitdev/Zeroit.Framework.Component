...
using Zeroit.Framework.Components.Modernized.Objects;
using static Zeroit.Framework.Components.Modernized.Utils.Animation;
using static Zeroit.Framework.Components.Modernized.Utils.ShadowUtils;
...
namespace Zeroit.Framework.Components.Modernized.Controls
{
    ...
    /// <seealso cref="Zeroit.Framework.Components.Modernized.Utils.ShadowUtils.IShadowController" />
    public class ZeroitSideBar : ContainerControl, IShadowController
    {
        ...
        {
            get => Parent is Zeroit.Framework.Components.Modernized.Forms.ModernForm ? ((Zeroit.Framework.Components.Modernized.Forms.ModernForm) Parent).ColorScheme : _colorScheme;
    ...
    /// Class SideBarItems.
    /// </summary>
    /// <seealso cref="Zeroit.Framework.Components.Modernized.Controls.SideBarItem" />
