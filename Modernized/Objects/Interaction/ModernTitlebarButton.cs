...
namespace Zeroit.Framework.Components.Modernized.Objects.Interaction
{
    /// <summary>
    ...
    public class ModernTitlebarButton
    {
        ...
        public virtual int Width { get; set; } = Zeroit.Framework.Components.Modernized.Forms.ModernForm.DefaultTitlebarHeight;
        /// <summary>
