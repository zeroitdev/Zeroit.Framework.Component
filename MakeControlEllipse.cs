...
// ***********************************************************************
// <copyright file="MakeControlEllipse.cs" company="Zeroit Dev Technologies">
...
{
    /// <summary>
    /// Class ZeroitMakeEllipse.
    /// </summary>
    /// <seealso cref="System.ComponentModel.Component" />
    public class ZeroitMakeEllipse : Component
	{
        /// <summary>
        /// The refresh UI
        /// </summary>
		...
		public Control EffectedControl
		{
			...
			set
			{
				...
				{
					this.effectedControl.Region = Region.FromHrgn(ZeroitMakeEllipse.CreateRoundRectRgn(0, 0, this.effectedControl.Width, this.effectedControl.Height, 0, 0));
				}
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZeroitMakeEllipse"/> class.
        /// </summary>
        public ZeroitMakeEllipse()
		{
		...
		{
			this.effectedControl.Region = Region.FromHrgn(ZeroitMakeEllipse.CreateRoundRectRgn(0, 0, this.effectedControl.Width, this.effectedControl.Height, this.cornerRadius, this.cornerRadius));
		}
